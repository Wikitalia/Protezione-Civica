...
//var zoom = <?=$zoom?>;
var modena = new google.maps.LatLng(44.647115, 10.9251857);
var initialLocation = modena;
var zoom = 8;
			...
			<div id="infoBoxContent" class="ultimeSegnalazioni">\
					<div class="leftAvatar">\
						<div style="width:35px; float:left;">\
							<a href="<?=$settings['sito']['vediProfilo']?>?idu='+segnalazione.id_utente+'" target="_blank"><img src="<?=$settings['sito']['url']?>resize.php?w=30&h=30&f='+segnalazione.avatar+'" alt="'+segnalazione.nome+' '+segnalazione.cognome+'" /></a>\
						</div>\
					</div>\
