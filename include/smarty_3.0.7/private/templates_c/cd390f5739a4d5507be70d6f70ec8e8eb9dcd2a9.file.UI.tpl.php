<?php /* Smarty version Smarty-3.0.7, created on 2012-05-07 13:30:01
         compiled from "/var/www/test.decorourbano.org/templates/includes/UI.tpl" */ ?>
<?php /*%%SmartyHeaderCode:3195659104fa7b2398a0910-69486067%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cd390f5739a4d5507be70d6f70ec8e8eb9dcd2a9' => 
    array (
      0 => '/var/www/test.decorourbano.org/templates/includes/UI.tpl',
      1 => 1336390199,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '3195659104fa7b2398a0910-69486067',
  'function' => 
  array (
  ),
...
"><?php echo $_smarty_tpl->getConfigVariable('invia');?>
    ...
    <?php }else{ ?>
         <li><a href="<?php echo $_smarty_tpl->getVariable('settings')->value['sito']['registrati'];?>
?n=1"><?php echo $_smarty_tpl->getConfigVariable('invia');?>
</a></li>
    <?php }?>
        
        <?php if (isset($_smarty_tpl->getVariable('user',null,true,false)->value)&&(($_smarty_tpl->getVariable('page')->value=='listaSegnalazioni'&&isset($_smarty_tpl->getVariable('locType',null,true,false)->value)&&$_smarty_tpl->getVariable('locType')->value=='comune'&&$_smarty_tpl->getVariable('comune')->value['buone_pratiche']==1)||$_smarty_tpl->getVariable('page')->value=='inviaBuonaPratica')){?>
        <li <?php if ($_smarty_tpl->getVariable('page')->value=='inviaBuonaPratica'){?>class="selected"<?php }?>><a href="<?php echo $_smarty_tpl->getVariable('settings')->value['sito']['inviaBuonaPratica'];?>
"><?php echo $_smarty_tpl->getConfigVariable('inviaBuonaPratica');?>
</a></li>
				<?php }?>
...
" target="_blank"><div class="twIcon  marginR5"></div> <?php echo $_smarty_tpl->getConfigVariable('socialTwitter');?>
        ...
        <li><a href="<?php echo $_smarty_tpl->getVariable('settings')->value['sito']['ideascale'];?>
"><?php echo $_smarty_tpl->getConfigVariable('ideeDU');?>
</a></li>
...
"><?php echo $_smarty_tpl->getConfigVariable('suDU');?>
        ...
        <li><a href="<?php echo $_smarty_tpl->getVariable('settings')->value['sito']['wikitalia'];?>
" target="_blank"><?php echo $_smarty_tpl->getConfigVariable('wikitalia');?>
</a></li>
