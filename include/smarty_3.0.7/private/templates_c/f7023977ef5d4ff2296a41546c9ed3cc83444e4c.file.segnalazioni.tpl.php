<?php /* Smarty version Smarty-3.0.7, created on 2012-05-25 16:53:53
         compiled from "/var/www/test.decorourbano.org/templates/includes/segnalazioni.tpl" */ ?>
<?php /*%%SmartyHeaderCode:11220025554fbf9d013f0db7-64521862%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f7023977ef5d4ff2296a41546c9ed3cc83444e4c' => 
    array (
      0 => '/var/www/test.decorourbano.org/templates/includes/segnalazioni.tpl',
      1 => 1337957565,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '11220025554fbf9d013f0db7-64521862',
  'function' => 
  array (
  ),
...
function aggiungi_segnalazione_lista(posizione, segnalazione) {
	...
	segnalazioneListaHTML='\
		...
		<div class="segnUtente">\
			<div class="auto left"><a href="<?php echo $_smarty_tpl->getVariable('settings')->value['sito']['vediProfilo'];?>
?idu='+segnalazione.id_utente+'"><img src="/resize.php?w=25&h=25&f='+segnalazione.avatar+'" alt="" /></a></div>\
			<div class="auto left fBold"><a class="tdNone" href="<?php echo $_smarty_tpl->getVariable('settings')->value['sito']['vediProfilo'];?>
?idu='+segnalazione.id_utente+'">'+segnalazione.nome+' '+segnalazione.cognome+'</a>';
...
: '+segnalazione.tipo_nome+'</div>\
					<div id="segnalazione_data_'+segnalazione.id_segnalazione+'" class="fontS10 marginB5">'+relativeTime(segnalazione.data); 
						if (segnalazione.client=='iPhone')
							segnalazioneListaHTML += ' via <a href="<?php echo $_smarty_tpl->getVariable('settings')->value['sito']['applicazioni'];?>
">iPhone</a>';
...
/images/'+img_stato+'" alt="Stato Segnalazione" class="imgStato">'+stato+' <a href="#"  title="Cosa significa in carico?" id="b_c"></a>';
 ...
 '+segnalazione.commenti.length+' <?php echo $_smarty_tpl->getConfigVariable('mostraComm2');?>
			...
			<div class="commentoBox">\
				<img src="/resize.php?w=30&h=30&f=<?php echo $_smarty_tpl->getVariable('user')->value['avatar'];?>
" alt="" />';
...
?idu='+commento.id_utente+'" class="fBold tdNone">'+commento.nome+' '+commento.cognome+'</a> ';
	if (commento.id_ruolo == 3)
...
&t_newer='+newest+'&c=1&w=1',
		<?php }elseif($_smarty_tpl->getVariable('page')->value=='vediProfilo'){?>
			url: '/ajax/segnalazioni_get.php?idu=<?php echo $_smarty_tpl->getVariable('user_profile')->value['id_utente'];?>
&t_newer='+newest+'&c=1',
		<?php }?>
