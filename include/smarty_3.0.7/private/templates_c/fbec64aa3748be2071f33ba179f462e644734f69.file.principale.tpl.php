<?php /* Smarty version Smarty-3.0.7, created on 2012-05-24 19:07:06
         compiled from "/var/www/test.decorourbano.org/templates/principale.tpl" */ ?>
<?php /*%%SmartyHeaderCode:18516579474fbe6aba48a974-78740768%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fbec64aa3748be2071f33ba179f462e644734f69' => 
    array (
      0 => '/var/www/test.decorourbano.org/templates/principale.tpl',
      1 => 1337879045,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '18516579474fbe6aba48a974-78740768',
  'function' => 
  array (
  ),
...
">Android</a></div>';
		if (segnalazione.client == 'Windows Phone') segnalazioneListaHTML+='<div class="auto fontS10" style="clear:left;">via <a href="<?php echo $_smarty_tpl->getVariable('settings')->value['sito']['applicazioni'];?>
">Windows Phone</a></div>';
		segnalazioneListaHTML+='\
					</div>\
				</div>\
...
" class="ultimeSegnalazioni <?php if (!$_smarty_tpl->getVariable('smarty')->value['foreach']['nuovaSegnalazione']['last']){?>borderBDashed<?php }?>" onclick="location.href='<?php echo $_smarty_tpl->tpl_vars['segnalazione']->value['url'];?>
'">
					<div class="leftAvatar">
						<a href="<?php echo $_smarty_tpl->getVariable('settings')->value['sito']['vediProfilo'];?>
...
">Android</a></div><?php }?>
						<?php if ($_smarty_tpl->tpl_vars['segnalazione']->value['client']=='Windows Phone'){?><div class="auto fontS10 clear"  style="clear:left;">via <a href="<?php echo $_smarty_tpl->getVariable('settings')->value['sito']['applicazioni'];?>
