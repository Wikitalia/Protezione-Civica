...
var emilia_romagna = new google.maps.LatLng(44.396761, 11.01864);
...
du_map.init = function(selector, initialLocation, zoom) {
  ...
  this.map.getDiv().addEventListener("DOMMouseScroll", function (e) {
...
function segnalazioni_nuove_get() {
	...
	if (!lock) {
		...
		$.ajax({
			url: base_url+'ajax/segnalazioni_get.php',
			data: dataString,
			dataType: "json",
