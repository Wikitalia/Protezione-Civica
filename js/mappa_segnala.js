...
function placeMarker(location) {
  ...
  var image = new google.maps.MarkerImage(sito_url+'images/marker_DU.png',
  ...
  geocoder.geocode( { 'address': address}, function(results, status) {
    if (status == google.maps.GeocoderStatus.OK) {
      ...
      lat = results[0].geometry.location.lat();
		  ...
		  if (citta == '') citta = (typeof(res['administrative_area_level_3']) == 'undefined')?'':res['administrative_area_level_3'].long_name;
		  if (citta == '') citta = (typeof(res['administrative_area_level_2']) == 'undefined')?'':res['administrative_area_level_2'].long_name;
